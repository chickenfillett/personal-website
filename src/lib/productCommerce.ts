...
const labels: Record<Locale, CommerceLabelCopy> = {
  zh: { priceEyebrow: "价格与可用性", priceTitle: "购买前先看清价格、试用和市场规则。", current: "当前价格", scheduled: "计划调整", trial: "免费试用", availability: "可用性", note: "说明", privacy: "隐私政策", legal: "法律与条款" },
  "zh-tw": { priceEyebrow: "價格與可用性", priceTitle: "購買前先看清價格、試用和市場規則。", current: "目前價格", scheduled: "計畫調整", trial: "免費試用", availability: "可用性", note: "說明", privacy: "隱私政策", legal: "法律與條款" },
  en: { priceEyebrow: "Pricing and availability", priceTitle: "Review price, trial, and market rules before installing.", current: "Current price", scheduled: "Scheduled change", trial: "Free trial", availability: "Availability", note: "Note", privacy: "Privacy policy", legal: "Legal terms" },
  ja: { priceEyebrow: "価格と提供状況", priceTitle: "インストール前に価格、試用、地域ルールを確認できます。", current: "現在の価格", scheduled: "予定されている変更", trial: "無料試用", availability: "提供状況", note: "注記", privacy: "プライバシーポリシー", legal: "法的条項" },
  ko: { priceEyebrow: "가격 및 제공 여부", priceTitle: "설치 전 가격, 체험판, 시장 규칙을 확인하세요.", current: "현재 가격", scheduled: "예정된 변경", trial: "무료 체험", availability: "제공 여부", note: "참고", privacy: "개인정보 처리방침", legal: "법률 및 약관" },
  fr: { priceEyebrow: "Prix et disponibilité", priceTitle: "Vérifiez le prix, l'essai et les règles de marché avant d'installer.", current: "Prix actuel", scheduled: "Changement prévu", trial: "Essai gratuit", availability: "Disponibilité", note: "Note", privacy: "Confidentialité", legal: "Mentions légales" },
  de: { priceEyebrow: "Preis und Verfügbarkeit", priceTitle: "Prüfe Preis, Testzeitraum und Marktregeln vor der Installation.", current: "Aktueller Preis", scheduled: "Geplante Änderung", trial: "Kostenlose Testphase", availability: "Verfügbarkeit", note: "Hinweis", privacy: "Datenschutz", legal: "Rechtliche Hinweise" },
  es: { priceEyebrow: "Precio y disponibilidad", priceTitle: "Revisa precio, prueba y reglas de mercado antes de instalar.", current: "Precio actual", scheduled: "Cambio programado", trial: "Prueba gratuita", availability: "Disponibilidad", note: "Nota", privacy: "Privacidad", legal: "Términos legales" },
  ru: { priceEyebrow: "Цена и доступность", priceTitle: "Перед установкой проверьте цену, пробный период и правила рынка.", current: "Текущая цена", scheduled: "Запланированное изменение", trial: "Бесплатный пробный период", availability: "Доступность", note: "Примечание", privacy: "Конфиденциальность", legal: "Правовые условия" },
  pt: { priceEyebrow: "Preço e disponibilidade", priceTitle: "Veja preço, teste e regras de mercado antes de instalar.", current: "Preço atual", scheduled: "Alteração prevista", trial: "Teste gratuito", availability: "Disponibilidade", note: "Nota", privacy: "Privacidade", legal: "Termos legais" },
};
